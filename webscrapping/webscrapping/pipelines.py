...
#         return item
#password = os.environ.get("MANGODB_PASS")


# class MangodbPipeline:
#     ollection_name = 'transcript'

#     def open_spider(self, spider):
#         self.client = pymongo.MongoClient(
#             "mongodb+srv://gyasifred:<password>@cluster0.xubwhxx.mongodb.net/?retryWrites=true&w=majority")
#         self.db = self.client("Movies_Database")
